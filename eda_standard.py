...
def standardize_objectives(objectives, items, n_obj,n_selected):
    ...
    stan_objectives = (objectives - items_q5*n_selected) / (items_q95*n_selected - items_q5*n_selected + 1e-12)

    return stan_objectives
...
class KnapsackEDA: 
    ...
    def _generate_initial_population(self):
        ...
        if self.aspi is not None:
            ...
            reweight_prob = compute_reweight_prob(self.aspi, selected_population, selected_objectives_stan, 
