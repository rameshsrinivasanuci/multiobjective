...
def main():
    ...
    # # organize results    
    # results = eda.run()
    # with open(f'final_2_3_60_6_obj3_run{run}_test2.pkl', 'wb') as f:
    #     pickle.dump(results, f)
    ...
    # ax.set_ylabel('Obj 2')
    # ax.set_zlabel('Obj 3')
    # plt.savefig(f'pf_compare_2_3_120_12_obj4_run{run}.png', dpi=300, bbox_inches='tight')
    # plt.close()
    ...
    #             dominated[i] = 1
    #             break
    # print(np.sum(dominated)/len(pf_predicted))
